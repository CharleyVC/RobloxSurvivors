...
local function onPlayerAdded(player)
	...
	if profile then
		...
		-- One-time starter revive
		if profile.Data.StarterReviveGranted ~= true then
			profile.Data.ReviveTokens = (profile.Data.ReviveTokens or 0) + 1
			profile.Data.StarterReviveGranted = true
		end
		

		profile.Data.SessionLockouts = profile.Data.SessionLockouts or {}
